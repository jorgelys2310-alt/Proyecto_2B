...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Grupo 8 - Aplicaciones Web",
            "email": "jorge@epn.edu.ec"
        },
        "license": {
            "name": "MIT"
        },
    ...
    "paths": {
        ...
        "/receipts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Usuario y productos comprados",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/users/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Datos que se actualizarán",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "dto.CreateReceiptRequest": {
            ...
            "properties": {
                "items": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/dto.ReceiptItemRequest"
                    }
                },
                "userId": {
                    "type": "integer"
